...
//import bg.softuni.mobilele.entities.Model;
...
//
//import static bg.softuni.mobilele.entities.enums.ModelCategoryEnum.*;
//import static bg.softuni.mobilele.entities.enums.UserRoleEnum.*;
//
//@Component
//@Slf4j
...
//            new User("Dimitar", "Georgiev", "dimitar", "dimitar", Set.of(UserRoleEnum.BUYER))
//    );
//
//    public DataInitializer(BrandService brandService, OfferService offerService, UserService userService, ModelMapper modelMapper) {
...
//        SAMPLE_USERS.forEach(user -> userService.registerUser(this.modelMapper.map(user, UserRegisterModel.class)));
